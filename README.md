# Correos Tracking API For PHP
Correos Tracking API and webhook make it easy to integrate Correos Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Correos Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Correos Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Correos Tracking API](https://www.trackingmore.com/correos-spain-tracking.html)  to:

   *   Get Correos realtime tracking info of muti-carriers in one integration
   *   Provide Correos shipment tracking experience like Amazon
   *   Push Correos notifications of package update with webhook
   *   Verify Correos delivery exception before it is too late
